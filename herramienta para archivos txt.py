...
print('bienvenido a la herramienta para archivos txt')
...
if OP == 1:
    ...
    if OP2 == 's':
        ...
        time.sleep(0.75)                                             #estos cositos de time sleep y los punticos esos no hacen nada es solo para que parezca que la pc hace algo
        print('.')
        time.sleep(0.75)
        print('.')
        time.sleep(0.75)
